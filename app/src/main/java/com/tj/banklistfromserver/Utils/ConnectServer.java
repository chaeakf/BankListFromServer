...
//    필요한 서버 요청들을 하나하나 메쏘드로 만들어주자
    ...
    public static void getRequestInfoBank(Context context, /* 필요한 파라미터용 변수*/ final JsonResponseHandler handler){
...
//        ※ GET, DELETE 메쏘드는 필요 파라미터를 URL에 담아줘야함.
//        이 담는 과정을 쉽게 하려고 urlBuilder 사용
